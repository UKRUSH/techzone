...
export default function ProductsPage() {
  ...
  return (
    <>
      <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black pt-32">{/* Added pt-32 for header space */}
              ...
              {!mounted || loading ? (
                ...
                >
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-black/90 via-gray-900/95 to-black/90 backdrop-blur-xl border-2 border-red-500/50 rounded-3xl p-12 shadow-2xl">
                      ...
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                        <Button 
                          ...
                          className="bg-gradient-to-r from-red-500 via-red-600 to-orange-600 hover:from-red-600 hover:via-red-700 hover:to-orange-700 text-white font-black text-xl px-12 py-4 rounded-2xl shadow-2xl border-0 transition-all duration-300"
                        >
