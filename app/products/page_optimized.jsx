...
export default function ProductsPageOptimized() {
  ...
  // Loading state
  const showLoading = isLoading || (isSearching && !products.length);
          ...
          <main className="flex-1">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4 bg-black/60 backdrop-blur-md p-4 rounded-xl border border-yellow-400/20">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Badge className="bg-yellow-400/20 text-yellow-400 border-yellow-400/30">
                  ...
                  {pagination?.total || sortedProducts.length} products found
                </Badge>
            ...
            {showLoading ? (
              <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-gray-400">Loading premium components...</p>
              </div>
            ) : error ? (
