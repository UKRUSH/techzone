...
// INSTANT featured products data - zero loading time
const INSTANT_FEATURED = [
  { id: 1, name: "RTX 4090 Gaming GPU", price: 1599, category: "gpu", brand: "NVIDIA", rating: 5 },
  { id: 2, name: "Intel i9-13900K", price: 589, category: "cpu", brand: "Intel", rating: 5 },
  { id: 3, name: "Samsung 980 PRO 2TB", price: 299, category: "storage", brand: "Samsung", rating: 4 },
  { id: 4, name: "Corsair DDR5-5600 32GB", price: 399, category: "memory", brand: "Corsair", rating: 5 },
  { id: 5, name: "ASUS ROG Strix X670-E", price: 499, category: "motherboard", brand: "ASUS", rating: 4 },
  { id: 6, name: "Corsair RM850x PSU", price: 159, category: "power-supply", brand: "Corsair", rating: 5 }
];
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {INSTANT_FEATURED.slice(0, 3).map((product, index) => (
              <MemoizedMotion
                key={product.id}
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
